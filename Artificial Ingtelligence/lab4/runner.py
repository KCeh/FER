...
if __name__ == '__main__':
	...
	NN.addLayer(FunctionLayer(sigmoid))
	...
	mutationScale = 0.025 # Standard deviation of the gaussian noise
	...
	print_every = 500 # Print the output every this many iterations
